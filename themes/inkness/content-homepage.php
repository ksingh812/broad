	...
	<div class="entry-content">
		<div role="tabpanel">
			  ...
			  <ul class="nav nav-tabs" role="tablist">
			    <li role="presentation" class="active"><a href="#musicals" aria-controls="musicals" role="tab" data-toggle="tab">Broadway Musicals</a></li>
			    <li role="presentation"><a href="#plays" aria-controls="plays" role="tab" data-toggle="tab">Broadway Plays</a></li>
			    <li role="presentation"><a href="#off" aria-controls="off" role="tab" data-toggle="tab">Off-Broadway Shows</a></li>
			  </ul>
